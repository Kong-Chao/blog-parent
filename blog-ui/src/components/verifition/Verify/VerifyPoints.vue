...
<script type="text/babel">
     ...
     * @description 点选
     * */
    import {resetSize, _code_chars, _code_color1, _code_color2} from '@/utils/veriyfutil'
    import {aesEncrypt} from "@/utils/ase"
    import {reqGet,reqCheck}  from "@/api"
    import { computed, onMounted, reactive, ref,watch,nextTick,toRefs, watchEffect,getCurrentInstance,inject} from 'vue';
    export default {
        name: 'VerifyPoints',
        props: {
            //弹出式pop，固定fixed
